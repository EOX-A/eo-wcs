...
External reference for this OGC® document: http://www.opengis.net/doc/IS/WCS-application-profile-earth-observation/1.1 +
URL for this OGC® document: https://eox-a.github.io/eo-wcs/ +
PDF version: https://eox-a.github.io/eo-wcs/index.pdf +
Version: 1.1draft +
...
include::annexes/b_use-case-examples.adoc[]
include::annexes/c_revision-history.adoc[]
